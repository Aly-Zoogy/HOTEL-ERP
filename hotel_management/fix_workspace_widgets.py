...
المسار: hotel_management/hotel_management/fix_workspace_widgets.py
التشغيل: bench --site [site] execute hotel_management.hotel_management.fix_workspace_widgets.fix_all
"""
...
def fix_all():
    ...
    print("\nالخطوات التالية:")
    print("1. bench --site site1.local clear-cache")
